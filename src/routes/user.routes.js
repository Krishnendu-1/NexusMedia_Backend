...
router.post('/register', 
    ...
    upload.fields([//* fields is an array,used to store "different" "fields".
        {
            name: 'avatar',
            maxCount:1
        },
...
router.patch("/avatarUpdate",verifyJWT,upload.single("avatar"),AvatarUpdate);//only "single" file update and can be updated only if logged in ...here two middlewares are used...very important 
router.patch("/coverphotoUpdate",verifyJWT,upload.single("coverphoto"),CoverimageUpdate);//only "single" file update and can be updated only if logged in...same as above

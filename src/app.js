...
//routes declaration
//**we cant use app.get() since routes are in different file, 
//*this can be used only if "controller" and "routes" written in same file*/
app.use('/api/users', userRouter);//-->whenever this "/users" gets there "router" controller activates
//*the URL might look like--> http://localhost:8000/users/register or http://localhost:8000/users/login ...like that
